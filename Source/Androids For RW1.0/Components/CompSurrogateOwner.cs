...
namespace MOARANDROIDS
{
    public class CompSurrogateOwner : ThingComp
    {
        ...
        public void OnReplicate()
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(cpawn.kindDef, Faction.OfPlayer, PawnGenerationContext.NonPlayer, -1, true, false, false, false, true, false, 1f, false, true, true, false, true, false, false, null, null, null, cpawn.ageTracker.AgeBiologicalYearsFloat, cpawn.ageTracker.AgeChronologicalYearsFloat, cpawn.gender, cpawn.story.melanin, null);
