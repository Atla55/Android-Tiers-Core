...
namespace MOARANDROIDS
{
    public static class Utils
    {
        ...
        public static List<string> ExceptionAndroidCorpseList = new List<string> { "Corpse_Android1Tier", "Corpse_Android2Tier", "Corpse_Android3Tier", "Corpse_Android4Tier", "Corpse_Android5Tier", "Corpse_AT_HellUnit", "Corpse_ATPP_Android2TX", "Corpse_ATPP_Android3TX", "Corpse_ATPP_Android4TX", "Corpse_M7Mech", "Corpse_ATPP_Android2KTX" };
        ...
        public static Building_Bed getAvailableAndroidPodForCharging(Pawn android, bool M7=false)
        {
            ...
            foreach(var el in map.listerBuildings.allBuildingsColonistElecFire)
            {
                ...
                && !el.Destroyed && el.TryGetComp<CompPowerTrader>() != null)
                {
                    ...
                    && !(bed.GetCurOccupant(0) != null || (bed.owners.Count() != 0 && !bed.owners.Contains(android)))
        ...
        public static Pawn generateSurrogate(Faction faction, PawnKindDef kindDef, IntVec3 pos, Map map, bool spawn=false, bool external=false, int tile=-1,bool allowFood=true, bool inhabitant=false, int Gender = -1)
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(kindDef, faction, PawnGenerationContext.NonPlayer, tile, false, false, false, false, true, true, 1f, false, true, allowFood, inhabitant, false, false, false, null, null, null, null, null,gender, null, null);
        ...
        public static Pawn spawnCorpseCopy(Pawn pawn, bool kill=true)
        {
            ...
            PawnGenerationRequest request = new PawnGenerationRequest(pawn.kindDef, Faction.OfAncients, PawnGenerationContext.NonPlayer, -1, true, false, false, false, true, false, 1f, false, true, true, false, true, false, false, null, null, null, pawn.ageTracker.AgeBiologicalYearsFloat, pawn.ageTracker.AgeChronologicalYearsFloat ,pawn.gender, pawn.story.melanin, null);
