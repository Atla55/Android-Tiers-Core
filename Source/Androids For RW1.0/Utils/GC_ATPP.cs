...
namespace MOARANDROIDS
{
    public class GC_ATPP : GameComponent
    {
         ...
         */
        public List<Building> getHeatSensitiveDevicesByHotLevel(Map map, int hotLevel)
        {
        ...
        private void initNull()
        {
            ...
            if (savedIASCoalition == null)
                savedIASCoalition = new List<SettlementBase>();
            if (savedIASInsurrection == null)
                savedIASInsurrection = new List<SettlementBase>();
        ...
        private List<SettlementBase> savedIASCoalition = new List<SettlementBase>();
        private List<SettlementBase> savedIASInsurrection = new List<SettlementBase>();
