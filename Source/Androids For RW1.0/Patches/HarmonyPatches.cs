    ...
    internal static class MultiplePawnRacesAtStart
    {
        private static void Postfix(ref Pawn __result)
        {
            ...
            else
            {
                ...
                {
                    case 1:
                        request = new PawnGenerationRequest(MOARANDROIDS.PawnKindDefOf.AndroidT2ColonistGeneral, Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false, null, null, null, null, null, null, null, null);
                        break;
                    case 2:
                        request = new PawnGenerationRequest(MOARANDROIDS.PawnKindDefOf.AndroidT1ColonistGeneral, Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false, null, null, null, null, null, null, null, null);
                        break;
                    default:
                        request = new PawnGenerationRequest(Faction.OfPlayer.def.basicMemberKind, Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false, null, null, null, null, null, null, null, null);
                        break;
                }
                __result = null;
                try
