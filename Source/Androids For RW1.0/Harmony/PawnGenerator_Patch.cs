                    ...
                    if (!(request.Context == PawnGenerationContext.PlayerStarter && Utils.ExceptionPlayerStartingAndroidPawnKindList.Contains(request.KindDef.defName))) {
                            ...
                            && Rand.Chance(0.95f))
                        {
                            PawnGenerationRequest r = new PawnGenerationRequest(PawnKindDefOf.AncientSoldier, request.Faction, request.Context, request.Tile, request.ForceGenerateNewPawn, request.Newborn,
                                ...
                                request.ForceRedressWorldPawnIfFormerColonist, request.WorldPawnFactionDoesntMatter, request.ValidatorPreGear, request.ValidatorPostGear,
                                request.MinChanceToRedressWorldPawn, request.FixedBiologicalAge, request.FixedChronologicalAge, request.FixedGender, request.FixedMelanin, request.FixedLastName);
