        ...
        public class NewGeneratedStartingPawn_Patch
        {
            ...
            public static void Listener(ref Pawn __result)
            {
                ...
                else
                {
                    ...
                    request = new PawnGenerationRequest(DefDatabase<PawnKindDef>.GetNamed(pkd, false), Faction.OfPlayer, PawnGenerationContext.PlayerStarter, -1, true, false, false, false, true, TutorSystem.TutorialMode, 20f, false, true, true, false, false, false, false, null, null, null, null, null, null, null, null);
                    __result = null;
                    try
                    {
