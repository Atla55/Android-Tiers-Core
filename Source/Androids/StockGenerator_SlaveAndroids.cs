        ...
        public class StockGenerator_SlaveAndroids : StockGenerator
        {
            public override IEnumerable<Thing> GenerateThings(int forTile)
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    Faction faction = androidFaction;
                    PawnGenerationRequest request = new PawnGenerationRequest(android, faction, PawnGenerationContext.NonPlayer, forTile, false, false, false, false, true, false, 1f, !this.trader.orbital, true, true, false, false, false, false, null, null, null, null, null, null, null, null);
